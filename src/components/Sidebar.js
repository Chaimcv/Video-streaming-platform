  ...
  return (
    <div className='p-5 shadow-md w-60'>
        ...
        <ul>
            ...
            <li className=' hover:bg-slate-100 rounded-lg'> <img className="w-5 h-5 inline-flex m-2" src="https://img.icons8.com/?size=24&id=ajczeHCWXbyR&format=png" alt='shorts' /></li>
            <li className=' hover:bg-slate-100 rounded-lg'><img className="w-5 h-5 inline-flex m-2" src="https://img.icons8.com/?size=100&id=DA3vWy7pLcg6&format=png&color=000000" alt="subscription" /> </li>
        </ul>
         <br />
        ...
        <ul>
             <li className=' hover:bg-slate-100 rounded-lg' ><img className="w-5 h-5 inline-flex m-2" src='https://w7.pngwing.com/pngs/257/93/png-transparent-settings-gear-icon-gear-configuration-set-up-thumbnail.png' /></li>
             <li className=' hover:bg-slate-100 rounded-lg' ><img className="w-4 h-4 inline-flex m-2" src='https://www.svgrepo.com/show/438202/content-flag-report-win-mark-icon.svg'/></li>
             <li className=' hover:bg-slate-100 rounded-lg' ><img className="w-5 h-5 inline-flex m-2" src='https://w7.pngwing.com/pngs/317/872/png-transparent-youtube-play-button-computer-icons-help-text-trademark-sign-thumbnail.png' /></li>
             <li className=' hover:bg-slate-100 rounded-lg' ><img className="w-5 h-5 inline-flex m-2"src='https://cdn.iconscout.com/icon/free/png-512/free-feedback-icon-svg-download-png-1513839.png?f=webp&w=256' /></li>
        </ul>
        < br/>
